        ...
        Definition.union('HostRequest',
            ...
            properties: [
              ...
              Property(
                'context',
                type: 'String',
                description: 'An opaque token generated by the host. This '
                    'token is valid during the span of the [HostReqest] and '
                    'allows macros to make [MacroRequest]s associated with '
                    'this context by setting [MacroRequest.context] to this '
                    'value. This mechanism allows associating incoming macro '
                    'requests with the phase the macro is currently running '
                    'in, which is used to e.g. verify the validity of queries.',
              ),
            ]),
